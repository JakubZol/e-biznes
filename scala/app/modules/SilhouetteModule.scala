...
import models.{PasswordInfoRepository, UserRepository}
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  @Provides
  def providePasswordDAO(userRepository: UserRepository): DelegableAuthInfoDAO[PasswordInfo] = new PasswordInfoRepository(userRepository)
